...
def kirjeldus_aknasse(t:str,r:str):
    if (askyesno("Küsimus","Kas tahad kirjeldust näha?")):
        ...
        c=Canvas(alam_aken,height=800,width=800)
...
#Понедельник
b1 = Button(aken, text = "Multimeedia", bg = "cornflowerblue", relief = "groove",command=lambda:kirjeldus_aknasse("Gert.png","Multimeedia"))
b1.grid(row = 1, column = 2, columnspan = 2, sticky = N+S+W+E)
b2 = Button(aken, text = "Programmeerimise alused", bg = "skyblue", relief = "groove",command=lambda:kirjeldus_aknasse("ty.png","Programmeerimise alused"))
...
b4 = Button(aken, text = "Multimeedia", bg = "cornflowerblue", relief = "groove",command=lambda:kirjeldus_aknasse("Gert.png","Multimeedia"))
b4.grid(row = 2, column = 5, columnspan = 2, sticky = N+S+W+E)
b5 = Button(aken, text = "Rühma \n juhataja \n tund", bg = "skyblue", relief = "groove",command=lambda:kirjeldus_aknasse("Rühm.png","Rühma juhataja tund"))
#Вторник
b5.grid(row = 1, column = 8, rowspan = 2, sticky = N+S+W+E)
b6 = Button(aken, text = "Inglise keel", bg = "oldlace", relief = "groove",command=lambda:kirjeldus_aknasse("12.png","Inglise keel1"))
b6.grid(row = 3, column = 2, columnspan = 2, sticky = N+S+W+E)
b7 = Button(aken, text = "Inglise keel", bg = "plum", relief = "groove",command=lambda:kirjeldus_aknasse("13.png","Inglise keel2"))
...
b13 = Button(aken, text = "Programmeerimise alused", bg = "skyblue", relief = "groove",command=lambda:kirjeldus_aknasse("ty.png","Programmeerimise alused"))
b13.grid(row = 5, column = 2, columnspan = 3, sticky = N+S+W+E)
b14 = Button(aken, text = "Multimeedia", bg = "cornflowerblue", relief = "groove",command=lambda:kirjeldus_aknasse("Gert.png","Multimeedia"))
...
b16 = Button(aken, text = "Programmeerimise alused", bg = "skyblue", relief = "groove",command=lambda:kirjeldus_aknasse("ty.png","Programmeerimise alused"))
